...
export async function GET(request: Request) {
  ...
  if (session.role === 'student') {
    ...
    return json({ student, profile, preferences, rounds, plans, reviews, official, curriculum, trackCourseGuides, courseDescriptions, requirements });
  }
  ...
  return json({ entranceYear, students, plans, planCourses, planPreferences, planRequirements, planReviews, issues, files, rounds, curriculum, trackCourseGuides, courseDescriptions, referenceUploads, schoolCourseGuides, educationOfficeCourseGuides, universityReferenceEntries, trackReferenceEntries, audit, comparisons, validations });
}
