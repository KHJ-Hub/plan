...
export async function GET(request: Request) {
  ...
  return json({ entranceYear, students, plans, planCourses, planPreferences, planRequirements, planReviews, issues, files, rounds, curriculum, courseDescriptions, referenceUploads, schoolCourseGuides, universityReferenceEntries, trackReferenceEntries, audit, comparisons, validations });
}
